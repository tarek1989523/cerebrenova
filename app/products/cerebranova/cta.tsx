...
export default function ProductCerebraNovaCTA() {
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#0284c7] to-[#0e7490]" />
      ...
      <div className="morph-blob w-[400px] h-[400px] bg-gradient-to-r from-[#38bdf8] to-[#22d3ee] opacity-[0.15] bottom-[-20%] left-[-10%]" style={{ filter: "blur(80px)" }} />
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex justify-center gap-6 mt-8">
            <a href="/" className="text-blue-200/70 hover:text-white text-sm transition-colors underline underline-offset-2">← Back to Home</a>
            <a href="/products/turmeric" className="text-blue-200/70 hover:text-white text-sm transition-colors underline underline-offset-2">View Turmeric Extract →</a>
          </div>
        </motion.div>
      </div>
    </section>
